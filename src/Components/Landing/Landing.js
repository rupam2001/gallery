        ...
        <div className='landing'>
            ...
            <div className="d-flex justify-content-end align-items-center mx-4 motion-toggler" data-aos="fade-left">
                ...
                <Toggler
                    ...
                    marginBottom={0}
                    onChange={() => { motionToggler ? setmotionToggler(false) : setmotionToggler(true) }}
                />
            </div>
            <div className="section-showcase show-1" id="my-work">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col d-flex align-items-center justify-content-center i1" data-aos="zoom-in-down">
                            <div
                                onClick={() => { preview("https://i.picsum.photos/id/101") }}>
                                <TiltCard imageUrl="https://i.picsum.photos/id/101/500/500.jpg" motion={motionToggler} />
                            </div>
                        </div>
                        <div className="col d-flex align-items-center justify-content-center i2" data-aos="zoom-in-down" data-aos-delay={AOSDelay}>
                            <div
                                onClick={() => { preview("https://i.picsum.photos/id/143") }}>
                                <TiltCard imageUrl="https://i.picsum.photos/id/143/500/500.jpg" motion={motionToggler} />
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col d-flex align-items-start justify-content-center i3" data-aos="zoom-in-down">
                            <div
                                onClick={() => { preview("https://i.picsum.photos/id/300") }}>
                                <TiltCard imageUrl="https://i.picsum.photos/id/300/500/500.jpg" motion={motionToggler} />
                            </div>
                        </div>
                        <div className="col d-flex align-items-center justify-content-center i4" data-aos="zoom-in-down" data-aos-delay={AOSDelay}>
                            <div
                                onClick={() => { preview("https://i.picsum.photos/id/104") }}>
                                <TiltCard imageUrl="https://i.picsum.photos/id/104/500/500.jpg" motion={motionToggler} />
                            </div>
                        </div>
                    </div>
                </div>
